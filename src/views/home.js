...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Affectionate Timely Porpoise</title>
        <meta property="og:title" content="Affectionate Timely Porpoise" />
      </Helmet>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Powerful JSON Output
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Experience the convenience of generating JSON effortlessly
                    </span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
            ...
            <div className="home-container03">
              ...
              <FeatureCard
                heading="Feature 2"
                subHeading="Efficient and reliable JSON generation"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 3"
                subHeading="Customizable JSON output options"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 4"
                subHeading="Support for nested JSON structures"
              ></FeatureCard>
            </div>
          </div>
        </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Experience the Wonder of Abracadabra
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Abracadabra is a revolutionary platform that brings the world
                  of magic and illusion to your fingertips. With our
                  cutting-edge technology and expert magicians, we create
                  unforgettable experiences that will leave you spellbound.
                  Whether you&apos;re a fan of close-up magic, mind reading, or
                  grand illusions, Abracadabra has something for everyone. Join
                  us on this enchanting journey and discover the true power of
                  magic.
                </span>
                <span>
                  <span
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Abracadabra is a magical platform that offers a wide range of services and products to make your life easier and more enjoyable."
                question="What is Abracadabra?"
              ></Question1>
              <Question1
                answer="Signing up for Abracadabra is quick and easy. Simply visit our website and click on the 'Sign Up' button to create your account."
                question="How can I sign up for Abracadabra?"
              ></Question1>
              <Question1
                answer="Abracadabra offers a variety of services including home cleaning, pet sitting, personal training, event planning, and much more. Check out our website to explore all the services we provide."
                question="What services does Abracadabra offer?"
              ></Question1>
              <Question1
                answer="If you have any questions or need assistance, you can reach our customer support team by emailing support@abracadabra.com or by calling our toll-free number at 1-800-ABRA-123."
                question="How can I contact Abracadabra customer support?"
              ></Question1>
              <Question1
                answer="Abracadabra is continuously expanding its services to new cities. To check if we are available in your city, please visit our website and enter your location in the search bar."
                question="Is Abracadabra available in my city?"
              ></Question1>
            </div>
          </div>
        </div>
